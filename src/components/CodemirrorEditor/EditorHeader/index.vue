...
import { ChevronDownIcon, Database, Moon, PanelLeftClose, PanelLeftOpen, Settings, Sun } from 'lucide-vue-next'

const emit = defineEmits([`addFormat`, `formatContent`, `startCopy`, `endCopy`, `toggleBackupManager`])
  ...
  <header class="header-container h-15 flex items-center justify-between px-5 dark:bg-[#191c20]">
    ...
    <div class="space-x-2 flex">
      ...
      <TooltipProvider :delay-duration="200">
        <Tooltip>
          <TooltipTrigger as-child>
            <Button variant="outline" @click="$emit('toggleBackupManager')">
